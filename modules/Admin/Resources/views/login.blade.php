...
<head>
    ...
    <link href="{{ Module::asset('admin:global/css/font.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:global/plugins/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:global/plugins/simple-line-icons/simple-line-icons.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:global/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:global/plugins/uniform/css/uniform.default.css')}}" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="{{ Module::asset('admin:admin/pages/css/login.css')}}" rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME STYLES -->
    <link href="{{ Module::asset('admin:global/css/components-rounded.css')}}" id="style_components" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:global/css/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:admin/layout/css/layout.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ Module::asset('admin:admin/layout/css/themes/default.css')}}" rel="stylesheet" type="text/css" id="style_color"/>
    <link href="{{ Module::asset('admin:admin/layout/css/custom.css')}}" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<div class="logo">
    <a href="{{ url() }}">
        <img src="{{ Module::asset('admin:uploads/logo/logo.png')}}" alt=""/>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="{{ Module::asset('admin:global/plugins/respond.min.js')}}"></script>
<script src="{{ Module::asset('admin:global/plugins/excanvas.min.js')}}"></script>
<![endif]-->
...
<script src="{{ Module::asset('admin:global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
...
<script src="{{ Module::asset('admin:admin/pages/scripts/login.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
